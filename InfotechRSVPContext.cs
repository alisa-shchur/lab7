...
namespace RSVP_website_SSTU
{
    public partial class InfotechRSVPContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\horan\\OneDrive\\Документы\\Rsvp.mdf;Integrated Security=True;Connect Timeout=30");
            }
        }
